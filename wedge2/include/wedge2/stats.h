#ifndef WEDGE2_STATS_H
#define WEDGE2_STATS_H
...
class WEDGE2_EXPORT Fixed_Stats
{
public:
	Fixed_Stats();
...
class WEDGE2_EXPORT Base_Stats
{
public:
	Base_Stats();
...
class WEDGE2_EXPORT Weapon_Stats
{
public:
	Weapon_Stats();
	Weapon_Stats(int id);
...
class WEDGE2_EXPORT Armour_Stats
{
public:
	Armour_Stats();
	Armour_Stats(int id);
...
class WEDGE2_EXPORT Player_Stats
{
public:
	Player_Stats();
