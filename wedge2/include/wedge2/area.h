#ifndef WEDGE2_AREA_H
#define WEDGE2_AREA_H
...
class WEDGE2_EXPORT Area_Hooks
{
public:
	struct Scroll_Zone
	{
...
bool WEDGE2_EXPORT entity_y_compare(Map_Entity *a, Map_Entity *b);
