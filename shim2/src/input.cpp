...
#ifndef STEAMWORKS // On Steam builds, we can't use JoystickGetAxis/etc because sometimes it's the dpad generating axis events
		Sint16 other_s = SDL_JoystickGetAxis(js->joy, 1-axis);
		float other = TGUI4_NORMALISE_JOY_AXIS(other_s);
