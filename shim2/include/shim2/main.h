...
#else
#ifdef SHIM2_BUILD
#define SHIM2_EXPORT __declspec(dllexport)
#else
#define SHIM2_EXPORT __declspec(dllimport)
#endif
#endif

#define EXPORT_STRUCT_ALIGN(x, n) __declspec(align(n)) struct SHIM2_EXPORT x
#define EXPORT_CLASS_ALIGN(x, n) __declspec(align(n)) class SHIM2_EXPORT x
...
extern SHIM2_EXPORT glStencilFuncSeparate_func glStencilFuncSeparate_ptr;
extern SHIM2_EXPORT glStencilOpSeparate_func glStencilOpSeparate_ptr;
extern SHIM2_EXPORT glBindFramebuffer_func glBindFramebuffer_ptr;
extern SHIM2_EXPORT glDeleteRenderbuffers_func glDeleteRenderbuffers_ptr;
extern SHIM2_EXPORT glGenFramebuffers_func glGenFramebuffers_ptr;
extern SHIM2_EXPORT glGenRenderbuffers_func glGenRenderbuffers_ptr;
extern SHIM2_EXPORT glBindRenderbuffer_func glBindRenderbuffer_ptr;
extern SHIM2_EXPORT glFramebufferTexture2D_func glFramebufferTexture2D_ptr;
extern SHIM2_EXPORT glRenderbufferStorage_func glRenderbufferStorage_ptr;
extern SHIM2_EXPORT glCheckFramebufferStatus_func glCheckFramebufferStatus_ptr;
extern SHIM2_EXPORT glDeleteFramebuffers_func glDeleteFramebuffers_ptr;
extern SHIM2_EXPORT glFramebufferRenderbuffer_func glFramebufferRenderbuffer_ptr;
extern SHIM2_EXPORT glUseProgram_func glUseProgram_ptr;
extern SHIM2_EXPORT glUniform1f_func glUniform1f_ptr;
extern SHIM2_EXPORT glUniform2f_func glUniform2f_ptr;
extern SHIM2_EXPORT glUniform3f_func glUniform3f_ptr;
extern SHIM2_EXPORT glUniform4f_func glUniform4f_ptr;
extern SHIM2_EXPORT glUniform1i_func glUniform1i_ptr;
extern SHIM2_EXPORT glUniform2i_func glUniform2i_ptr;
extern SHIM2_EXPORT glUniform3i_func glUniform3i_ptr;
extern SHIM2_EXPORT glUniform4i_func glUniform4i_ptr;
extern SHIM2_EXPORT glUniform1fv_func glUniform1fv_ptr;
extern SHIM2_EXPORT glUniform2fv_func glUniform2fv_ptr;
extern SHIM2_EXPORT glUniform3fv_func glUniform3fv_ptr;
extern SHIM2_EXPORT glUniform4fv_func glUniform4fv_ptr;
extern SHIM2_EXPORT glUniform1iv_func glUniform1iv_ptr;
extern SHIM2_EXPORT glUniform2iv_func glUniform2iv_ptr;
extern SHIM2_EXPORT glUniform3iv_func glUniform3iv_ptr;
extern SHIM2_EXPORT glUniform4iv_func glUniform4iv_ptr;
extern SHIM2_EXPORT glUniformMatrix2fv_func glUniformMatrix2fv_ptr;
extern SHIM2_EXPORT glUniformMatrix3fv_func glUniformMatrix3fv_ptr;
extern SHIM2_EXPORT glUniformMatrix4fv_func glUniformMatrix4fv_ptr;
extern SHIM2_EXPORT glDeleteShader_func glDeleteShader_ptr;
extern SHIM2_EXPORT glCreateProgram_func glCreateProgram_ptr;
extern SHIM2_EXPORT glDeleteProgram_func glDeleteProgram_ptr;
extern SHIM2_EXPORT glAttachShader_func glAttachShader_ptr;
extern SHIM2_EXPORT glLinkProgram_func glLinkProgram_ptr;
extern SHIM2_EXPORT glGetAttribLocation_func glGetAttribLocation_ptr;
extern SHIM2_EXPORT glEnableVertexAttribArray_func glEnableVertexAttribArray_ptr;
extern SHIM2_EXPORT glVertexAttribPointer_func glVertexAttribPointer_ptr;
extern SHIM2_EXPORT glGetUniformLocation_func glGetUniformLocation_ptr;
extern SHIM2_EXPORT glShaderSource_func glShaderSource_ptr;
extern SHIM2_EXPORT glCompileShader_func glCompileShader_ptr;
extern SHIM2_EXPORT glGetShaderiv_func glGetShaderiv_ptr;
extern SHIM2_EXPORT glGetShaderInfoLog_func glGetShaderInfoLog_ptr;
extern SHIM2_EXPORT glCreateShader_func glCreateShader_ptr;
extern SHIM2_EXPORT glBlendFunc_func glBlendFunc_ptr;
extern SHIM2_EXPORT glEnable_func glEnable_ptr;
extern SHIM2_EXPORT glDisable_func glDisable_ptr;
extern SHIM2_EXPORT glFrontFace_func glFrontFace_ptr;
extern SHIM2_EXPORT glCullFace_func glCullFace_ptr;
extern SHIM2_EXPORT glScissor_func glScissor_ptr;
extern SHIM2_EXPORT glViewport_func glViewport_ptr;
extern SHIM2_EXPORT glClearColor_func glClearColor_ptr;
extern SHIM2_EXPORT glClear_func glClear_ptr;
extern SHIM2_EXPORT glClearDepthf_func glClearDepthf_ptr;
#if !defined ANDROID && !defined IOS
extern SHIM2_EXPORT glClearDepth_func glClearDepth_ptr;
#endif
extern SHIM2_EXPORT glClearStencil_func glClearStencil_ptr;
extern SHIM2_EXPORT glDepthMask_func glDepthMask_ptr;
extern SHIM2_EXPORT glDepthFunc_func glDepthFunc_ptr;
extern SHIM2_EXPORT glStencilFunc_func glStencilFunc_ptr;
extern SHIM2_EXPORT glStencilOp_func glStencilOp_ptr;
extern SHIM2_EXPORT glStencilFuncSeparate_func glStencilFuncSeparate_ptr;
extern SHIM2_EXPORT glActiveTexture_func glActiveTexture_ptr;
extern SHIM2_EXPORT glColorMask_func glColorMask_ptr;
extern SHIM2_EXPORT glDeleteTextures_func glDeleteTextures_ptr;
extern SHIM2_EXPORT glGenTextures_func glGenTextures_ptr;
extern SHIM2_EXPORT glBindTexture_func glBindTexture_ptr;
extern SHIM2_EXPORT glTexImage2D_func glTexImage2D_ptr;
extern SHIM2_EXPORT glTexParameteri_func glTexParameteri_ptr;
extern SHIM2_EXPORT glGetError_func glGetError_ptr;
extern SHIM2_EXPORT glDrawArrays_func glDrawArrays_ptr;
#endif
...
#include <tgui4/tgui4.h>
#include <tgui4/tgui4_sdl.h>

#include "shim2/basic_types.h"
